...
class ChatGPTController
{
    ...
    public static string FormatRequestForChatGPT(Dice.Entities.DiceSpread diceSpread)
    {
        string prompt = $@"
            ...
            Each dice roll holds a specific thematic significance, influencing the overall interpretation of its number. I seek a detailed interpretation based on numerology and gamatria, akin to a divination reading. The interpretation should offer practical insights and guidance tailored to my personal journey, decisions, or questions at hand. As you interpret the dice rolls, please consider Frameworks and Spiritual Principles from the following sources: 
